...
public abstract class AbstractTxnPayload implements java.io.Serializable {
	...
	/**
	 * @param authRolesRegistryDO the authRolesRegistryDO to set
	 */
	...
	/**
	 * @param authUserRegistryDO the authUserRegistryDO to set
	 */
	...
	/**
	 * @param authUserroleAccesscontrolDO the authUserroleAccesscontrolDO to set
	 */
	...
	/**
	 * @param authUserRoleAssocDO the authUserRoleAssocDO to set
	 */
	...
	/**
	 * @param authRolesRegistryDOList the authRolesRegistryDOList to set
	 */
	...
	/**
	 * @param authUserRegistryDOList the authUserRegistryDOList to set
	 */
	...
	/**
	 * @param authUserroleAccesscontrolDOList the authUserroleAccesscontrolDOList to set
	 */
	...
	/**
	 * @param authUserRoleAssocDOList the authUserRoleAssocDOList to set
	 */
	...
	/**
	 * @param searchAuthAccessControlDO the searchAuthAccessControlDO to set
	 */
